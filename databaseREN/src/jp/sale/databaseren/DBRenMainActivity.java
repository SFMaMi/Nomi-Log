...
public class DBRenMainActivity extends Activity 
		implements View.OnClickListener {
		  
		  static final String TAG = "SQLiteTest1";
		  static final int MENUITEM_ID_DELETE = 1;
		  static final int MENUITEM_ID_MOD = 2;
		  ...
		  static List<Note> noteList = new ArrayList<Note>();
		    ...
		    public void onCreate(Bundle savedInstanceState) {
		        ...
		        setContentView(R.layout.activity_dbren_main);
		        findViews();
		        setListeners();
		    ...
		    protected void saveItem(){
		      dbAdapter.open();
		      dbAdapter.saveNote(Shop.getText().toString());
		      dbAdapter.close();
		      Shop.setText("");
		      loadNote();
		    }
		  ...
		  public boolean onContextItemSelected(MenuItem item) {
		    ...
		    case MENUITEM_ID_MOD:
		    	Intent intent = new Intent(DBRenMainActivity.this, NLTabActivity.class);
				  // 次画面のアクティビティ起動
